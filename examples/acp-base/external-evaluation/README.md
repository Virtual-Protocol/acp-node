# ACP External Evaluation Example

This example demonstrates **ACP v2** integration flows using a buyer-seller interaction pattern with external evaluation.

## Overview

This example showcases use cases enabled by ACP's job and payment framework with external evaluation:
...
- **Specify Evaluator**: Use external evaluator instead of skipping evaluation
...
```bash
cd examples/acp-base/external-evaluation
